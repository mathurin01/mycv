...
class UserDAO extends DAO implements UserProviderInterface
{
     ...
     *
     * @return \Mycv\Domain\User|throws an exception if no matching user is found
     */
     ...
     *
     * @param \Mycv\Domain\User $user The user to save
     */
